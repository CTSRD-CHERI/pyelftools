...
ENUM_ST_INFO_TYPE = dict(
    ...
    STT_LOPROC=13,
    STT_HIPROC=15,
    STT_GNU_IFUNC=10, # FIXME: OS-specific
    _default_=Pass,
)
...
# Section types in .note.cheri notes
ENUM_CHERI_NOTE_N_TYPE = dict(
...
ENUM_CHERI_NOTE_GLOBALS_ABI = dict(
...
ENUM_RELOC_TYPE_AARCH64 = dict(
    ...
    R_MORELLO_LD_PREL_LO17=57348,
    R_MORELLO_ADR_PREL_PG_HI20=57349,
    R_MORELLO_ADR_PREL_PG_HI20_NC=57350,
    R_MORELLO_TSTBR14=57344,
    R_MORELLO_CONDBR19=57345,
    R_MORELLO_JUMP26=57346,
    R_MORELLO_CALL26=57347,
    R_MORELLO_MOVW_SIZE_G0=57353,
    R_MORELLO_MOVW_SIZE_G0_NC=57354,
    R_MORELLO_MOVW_SIZE_G1=57355,
    R_MORELLO_MOVW_SIZE_G1_NC=57356,
    R_MORELLO_MOVW_SIZE_G2=57357,
    R_MORELLO_MOVW_SIZE_G2_NC=57358,
    R_MORELLO_MOVW_SIZE_G3=57359,
    R_MORELLO_ADR_GOT_PAGE=57351,
    R_MORELLO_LD128_GOT_LO12_NC=57352,
    R_MORELLO_TLSDESC_ADR_PAGE20=57600,
    R_MORELLO_TLSDESC_LD128_LO12=57601,
    R_MORELLO_TLSDESC_CALL=57602,
    R_MORELLO_TLSIE_ADR_GOTTPREL_PAGE20=57603,
    R_MORELLO_TLSIE_ADD_LO12=57604,

    # Morello dynamic relocations
    R_MORELLO_CAPINIT=59392,
    R_MORELLO_GLOB_DAT=59393,
    R_MORELLO_JUMP_SLOT=59394,
    R_MORELLO_RELATIVE=59395,
